...
#             map_matrix = self.pad_map_to_900x900(map_matrix)
...
#             positions = np.argwhere(self.map_data == 99)
#             print("**************joel***************",positions)
...
class OdomAndMapPublisher(Node):
    ...
    def publish_synced_data(self):
        ...
        if self.map_data:
            ...
            updated_map_array2 = np.array(updated_map_msg.data).reshape((900, 900))
            positions = np.argwhere(updated_map_array2 == 99)
