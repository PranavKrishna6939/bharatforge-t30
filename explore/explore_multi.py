...
MAX_AREA = 1000  # Maximum number of free cells
MAX_TIMESTEPS = 5000
MAX_RANGE = 10
...
class ExplorationEnv:
    def __init__(self, number_of_bots=5):
        ...
        self.bot_positions = [initial_position for _ in range(self.number_of_bots)]
        for pos in self.bot_positions:
            self.explored_map[pos] = 5
        self.steps = 0
    ...
    def generate_map(self):
        ...
        self.mask = mask  # Store the mask for is_done
...
def main():
    num_bots = 5  # Set the desired number of bots
    model = ActorCritic(input_size=10000, num_bots=num_bots)
